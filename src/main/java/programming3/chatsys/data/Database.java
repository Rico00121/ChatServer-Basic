...
public interface Database {
     ...
     */
    Map<String, User> readUsers() throws SQLException;
     ...
     */
    List<ChatMessage> readMessages() throws SQLException;
    List<ChatMessage> readMessages(int n) throws SQLException;
    /**
     * Adds a ChatMessage to the database.
     * @param userName user who sends the message.
     * @param message the message to add.
     */
    ChatMessage addMessage(String userName, String message) throws SQLException;
     ...
     */
    List<ChatMessage> getUnreadMessages(String userName) throws SQLException;
}
